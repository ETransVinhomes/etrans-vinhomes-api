...
namespace Services.Services
{
	public class DriverService : IDriverService
	{
		...
		public async Task<DriverViewModel> GetDriverByIdAsync()
		{
		...
		public async Task<DriverViewModel> GetDriverByIdAsync(Guid id)
		{
			...
			var driver = await _unitOfWork.DriverRepository.FindByField(x => x.Id == id) ?? throw new Exception($"--> Error: Not found Driver with Id: {id}");
			return _mapper.Map<DriverViewModel>(driver);
		}
